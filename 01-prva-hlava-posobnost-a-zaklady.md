# Prvá časť — Všeobecná časť, Prvá hlava — Pôsobnosť zákona a základy trestnej zodpovednosti (§ 1 – § 30)

> **Téma kapitoly:** Úvodná kapitola vymedzuje **predmet zákona** (§ 1) a jeho **časovú, územnú, osobnú a medzinárodnú pôsobnosť** (§ 2 – § 7b), teda odpovedá na otázku, KEDY, KDE a NA KOHO sa Trestný zákon vzťahuje. Druhý diel potom kladie **základy trestnej zodpovednosti**: pojem a druhy trestného činu (§ 8 – § 18), páchateľ/spolupáchateľ/účastník (§ 19 – § 21) a okolnosti vylučujúce trestnú zodpovednosť či protiprávnosť činu — vek, nepríčetnosť, krajná núdza, nutná obrana, oprávnené použitie zbrane, dovolené riziko, výkon práva a povinnosti, súhlas poškodeného, plnenie úlohy agenta (§ 22 – § 30). Ide o dogmatický základ, na ktorom stoja všetky skutkové podstaty osobitnej časti.
...
Úvodné ustanovenie vymedzuje štyri pilierové oblasti úpravy: (1) základy trestnej zodpovednosti (kto a za akých podmienok zodpovedá — zvyšok tejto hlavy a Druhý diel), (2) druhy trestov a ich ukladanie (Druhá hlava, § 31 a nasl.), (3) druhy ochranných opatrení a ich ukladanie (rovnako Druhá hlava) a (4) skutkové podstaty trestných činov (Osobitná časť, § 144 a nasl.). Trestný zákon je tak kódexom hmotného trestného práva — na rozdiel od Trestného poriadku neupravuje procesný postup orgánov činných v trestnom konaní a súdov.
...
Základom je **teritoriálny princíp**. Odsek 2 ho rozširuje **zásadou ubikvity** — čin sa považuje za spáchaný na Slovensku, ak tu nastalo aspoň jedno z jeho miest (konanie ALEBO následok), aj keby druhé z nich nastalo v cudzine. To umožňuje stíhať napr. cezhraničnú trestnú činnosť, kde konanie prebehlo v zahraničí, ale škodlivý následok nastal na Slovensku (a naopak). Odsek 3 zakotvuje tzv. **vlajkový princíp** pre lode a lietadlá registrované v SR — tie sa považujú za slovenské územie bez ohľadu na to, kde sa fakticky nachádzajú.
...
Ide o **princíp personality (aktívny)** — Slovensko stíha svojich občanov a cudzincov s trvalým pobytom na jej území za činy spáchané kdekoľvek v zahraničí, bez ohľadu na to, či je čin trestný podľa práva miesta spáchania (na rozdiel od § 6, ktorý takú podmienku pre iných cudzincov vyžaduje).

### § 5 — Ochrana slovenského občana v zahraničí
...
**Princíp personality (pasívny)** — chráni slovenských občanov ako obete obzvlášť závažných zločinov spáchaných v cudzine, s podmienkou obojstrannej trestnosti (čin musí byť trestný aj v mieste spáchania), alebo ak dané miesto vôbec nepodlieha nijakej trestnej právomoci (napr. otvorené more).

### § 5a — Princíp univerzality
...
Zakotvuje **princíp univerzality** — pre taxatívne vymenovaný okruh obzvlášť závažných trestných činov (drogová kriminalita, legalizácia výnosov, falšovanie peňazí, terorizmus, vojnové zločiny, genocída) sa slovenská trestná právomoc uplatní bez ohľadu na to, kto a kde čin spáchal a bez podmienky obojstrannej trestnosti. Ide o premietnutie medzinárodných záväzkov SR (dohovory OSN o terorizme a drogách, medzinárodné humanitárne právo) do vnútroštátneho práva — tieto činy sú považované za natoľko závažné, že ich stíhanie má univerzálny, nie územne či osobne viazaný záujem.

### § 6 — Zastupovacia pôsobnosť
...
**Zastupovacia (vikariátna) pôsobnosť** rieši prípad, keď je páchateľ — cudzinec bez trvalého pobytu na Slovensku — zadržaný na slovenskom území, ale nie je vydaný cudziemu štátu (napr. z dôvodu zákazu vydania vlastných občanov iným štátom alebo z iných prekážok extradície). Slovensko ho v takom prípade "zastupuje" pri trestnom stíhaní namiesto štátu, kde bol čin spáchaný — podmienkou je obojstranná trestnosť (písm. a). Odsek 2 chráni páchateľa pred prísnejším postihom, než by mu hrozil podľa práva miesta spáchania (tzv. zákaz reformatio in peius medzi právnymi poriadkami).
...
Ustanovenie zabezpečuje súlad vnútroštátnej úpravy pôsobnosti s medzinárodnými záväzkami SR obojsmerne: odsek 1 rozširuje pôsobnosť zákona tam, kde to vyžaduje riadne ratifikovaná a vyhlásená medzinárodná zmluva (napr. špecifické extradičné alebo jurisdikčné dojednania), odsek 2 ju naopak obmedzuje, ak by uplatnenie § 3 až 6 bolo v rozpore so záväznou medzinárodnou zmluvou (typicky otázky diplomatickej či inej imunity upravené medzinárodným právom).
...
Dopĺňa všeobecnú pôsobnosť zákona (§ 2 – § 7) osobitne pre ochranné opatrenia. Odsek 2 je významný najmä pre ochranné liečenie a ochranný dohľad — tie možno uložiť aj páchateľovi, ktorý nie je trestne zodpovedný (napr. pre nepríčetnosť podľa § 23) alebo ktorého z iného dôvodu nemožno stíhať či odsúdiť; ochranné opatrenie totiž nemá represívny, ale ochranný a preventívny charakter, takže nie je viazané na vinu v trestnoprávnom zmysle.
...
Odsek 1 stanovuje všeobecnú podmienku uznania a výkonu cudzieho trestného rozhodnutia — musí na to existovať právny základ (medzinárodná zmluva alebo osobitný zákon, napr. o uznávaní a výkone rozhodnutí v EÚ). Odsek 2 je transpozíciou rámcového rozhodnutia EÚ o zohľadňovaní odsúdení v iných členských štátoch pri novom trestnom konaní (napr. pri posudzovaní recidívy alebo ukladaní súhrnného trestu) — odsúdenie súdom iného členského štátu EÚ sa postaví naroveň domácemu odsúdeniu, ak bol čin trestný aj podľa slovenského práva.
...
Legálna definícia trestného činu spočíva na dvoch znakoch: **protiprávnosti** (rozpor s právnym poriadkom ako celkom, nielen s trestným zákonom) a **normatívnej určenosti** — znaky činu musia byť uvedené v tomto zákone (zásada **nullum crimen sine lege**, žiadny trestný čin bez zákona). Dodatok "ak tento zákon neustanovuje inak" odkazuje na okolnosti vylučujúce protiprávnosť (§ 24 – § 30) — čin inak napĺňajúci znaky skutkovej podstaty nie je trestným činom, ak nastane niektorá z nich.
...
Základné binárne triedenie trestných činov podľa závažnosti — bližšie rozvedené v § 10 (prečin) a § 11 (zločin). Zaradenie do jednej z kategórií má zásadný praktický dosah (možnosť podmienečného zastavenia trestného stíhania, premlčacie doby, prísnosť trestov, procesné dôsledky podľa Trestného poriadku).
...
Prečinom je automaticky každý nedbanlivostný trestný čin (písm. a), a z úmyselných tie, kde horná hranica trestnej sadzby nepresahuje päť rokov (písm. b). Odsek 2 zavádza **materiálny korektív** — tzv. bagateľnú klauzulu: aj čin formálne napĺňajúci znaky prečinu nemusí byť trestným činom vôbec, ak je jeho konkrétna závažnosť nepatrná (posudzuje sa podľa spôsobu vykonania, následkov, okolností, miery zavinenia a pohnútky). Ide o prejav zásady subsidiarity trestnej represie (ultima ratio).
...
Zločinom je len úmyselný trestný čin s hornou hranicou sadzby nad päť rokov. Odsek 2 rieši situáciu kvalifikovaných skutkových podstát — ak základná skutková podstata je prečinom, ale jej kvalifikovaná (prísnejšia) forma má hornú hranicu nad päť rokov, ide v tejto kvalifikovanej forme o zločin. Odsek 3 definuje podkategóriu **obzvlášť závažného zločinu** (dolná hranica sadzby aspoň desať rokov) — na túto kategóriu sa viažu osobitné inštitúty v celom zákone (napr. § 5 ochrana slovenského občana v zahraničí, prísnejšie podmienky podmienečného prepustenia a i.).
...
Legálna definícia miesta spáchania nadväzuje na zásadu ubikvity zo § 3 ods. 2 — miestom spáchania je alternatívne miesto konania AJ miesto (skutočného alebo zamýšľaného) následku, čo môže viesť k tomu, že čin má súčasne viacero miest spáchania v rôznych štátoch.
...
Príprava je najskoršie štádium trestnej činnosti, ktoré zákon postihuje — a to výlučne pri zločinoch (na rozdiel od pokusu, ktorý je trestný pri akomkoľvek trestnom čine, pozri § 14). Trestá sa rovnakou sadzbou ako dokonaný zločin (odsek 2), typicky sa však táto okolnosť zohľadní pri určovaní konkrétneho trestu ako menej závažné štádium. Odsek 3 zakotvuje **dobrovoľné upustenie** a **oznamovaciu povinnosť** ako dôvody zániku trestnosti (analogicky k účinnej ľútosti) — motivujú páchateľa prerušiť vývoj trestnej činnosti skôr, než dôjde k pokusu či dokonaniu. Odsek 4 spresňuje, že zánik trestnosti prípravy sa netýka prípadného iného trestného činu, ktorý už páchateľ prípravným konaním spáchal (napr. nedovolené ozbrojovanie pri zadovažovaní zbrane).
...
Na rozdiel od prípravy je pokus trestný pri **akomkoľvek** trestnom čine, nielen pri zločine, a definičným znakom je, že konanie už **bezprostredne smeruje** k dokonaniu (teda je bližšie k následku než príprava). Trestá sa rovnakou sadzbou ako dokonaný čin (odsek 2). Odseky 3 a 4 zrkadlia konštrukciu § 13 ods. 3 a 4 (dobrovoľné upustenie/oznámenie ako dôvod zániku trestnosti pokusu, bez dotknutia zodpovednosti za iný, medzičasom už dokonaný trestný čin).

### § 15 a § 16 — Zavinenie (úmysel a nedbanlivosť)
...
> **§ 16**
>
> *(1) Trestný čin je spáchaný z nedbanlivosti, ak páchateľ*
>
...
Zakotvuje princíp, že **úmysel je pravidlom** a nedbanlivosť výnimkou — nedbanlivostná zodpovednosť fyzickej osoby nastupuje len tam, kde to konkrétna skutková podstata v osobitnej časti výslovne pripúšťa (napr. "kto z nedbanlivosti..."). Mlčanie zákona o forme zavinenia znamená požiadavku úmyslu.

### § 18 — Zavinenie okolností podmieňujúcich prísnejší trest
...
Upravuje zodpovednosť za tzv. **kvalifikačné okolnosti** (znaky privodujúce prísnejší trestný postih v rámci tej istej skutkovej podstaty — typicky "spôsobí ťažkú ujmu na zdraví", "spôsobí smrť"). Pravidlom je, že postačuje nedbanlivostné zavinenie aj tejto prísnejšej okolnosti (konštrukcia tzv. zmiešaného zavinenia — úmysel k základnej skutkovej podstate, nedbanlivosť k ťažšiemu následku), pokiaľ konkrétna skutková podstata výslovne nevyžaduje úmysel aj vo vzťahu ku kvalifikačnému znaku.
...
Odsek 2 potvrdzuje, že slovenské trestné právo pozná aj **trestnú zodpovednosť právnických osôb** — tá je však upravená samostatným osobitným predpisom (zákon č. 91/2016 Z. z. o trestnej zodpovednosti právnických osôb), nie priamo Trestným zákonom.
...
Zakotvuje zásadu **plnej zodpovednosti spolupáchateľa** — nezáleží na tom, akú konkrétnu čiastkovú úlohu v spoločnom konaní zohral, zodpovedá za trestný čin ako celok, rovnako, ako keby ho spáchal sám.
...
>
> *d) poskytol inému pomoc na spáchanie trestného činu, najmä zadovážením prostriedkov, odstránením prekážok, radou, utvrdzovaním v predsavzatí, sľubom pomôcť po trestnom čine (pomocník); za pomoc, zadovažovanie prostriedkov a poskytnutie rady sa nepovažuje poskytnutie právnej služby advokátom podľa osobitného predpisu.*
>
...
Rozlišuje štyri formy účastníctva (organizátorstvo, návod, objednanie, pomoc) — na rozdiel od spolupáchateľstva (§ 20) účastník sám osebe neuskutočňuje skutkovú podstatu, ale svojou úmyselnou činnosťou umožňuje alebo uľahčuje spáchanie činu iným. Účastníctvo je **akcesorické** — viaže sa na existenciu aspoň pokusu hlavného činu. Písm. d) obsahuje dôležitú výnimku pre advokátov poskytujúcich právnu službu, ktorá chráni riadny výkon advokácie pred kriminalizáciou bežného právneho poradenstva. Odsek 2 stanovuje, že na trestnosť účastníka sa použijú rovnaké pravidlá ako na páchateľa (napr. čo do trestnej sadzby), pokiaľ zákon výslovne neustanoví inak.
...
Stanovuje všeobecnú **hranicu trestnej zodpovednosti na 14 rokov** veku, so špecifickou výnimkou pre trestný čin sexuálneho zneužívania (§ 201), kde je hranica posunutá na 15 rokov — táto výnimka zohľadňuje, že vzťah medzi rovesníkmi tesne pod a nad hranicou pohlavnej dospelosti si vyžaduje odlišné posúdenie ako iné trestné činy.
...
Nepríčetnosť vylučuje trestnú zodpovednosť, ak pre duševnú poruchu chýbala buď **rozpoznávacia zložka** (schopnosť rozpoznať protiprávnosť činu), alebo **ovládacia zložka** (schopnosť ovládať svoje konanie) — postačuje absencia čo len jednej z nich. Nepríčetnému páchateľovi možno napriek vylúčeniu trestnej zodpovednosti uložiť ochranné opatrenie (pozri § 7a ods. 2).
...
Krajná núdza je **kolízia záujmov** — odvrátenie hroziaceho nebezpečenstva na úkor iného, menej hodnotného záujmu. Podmienkami sú subsidiarita (nebolo možné nebezpečenstvo odvrátiť inak, odsek 2) a proporcionalita (spôsobený následok nesmie byť zjavne závažnejší než hroziaci). Tretia veta odseku 2 vylučuje krajnú núdzu tam, kde má osoba zákonnú povinnosť nebezpečenstvo znášať (typicky príslušníci záchranných zborov pri výkone služby v medziach ich rizika).
...
Na rozdiel od krajnej núdze tu ide o reakciu priamo proti **útočníkovi**, nie o kolíziu neutrálnych záujmov — preto je požiadavka proporcionality miernejšia (obrana nesmie byť len "celkom zjavne neprimeraná", odsek 2), keďže právo nemusí ustupovať bezpráviu. Odsek 3 pridáva **ospravedlňujúci dôvod pre excesívnu obranu** spôsobenú silným rozrušením útokom (strach, zmätok, zľaknutie) — v takom prípade trestná zodpovednosť nenastáva ani pri prekročení medzí nutnej obrany. Odsek 4 rieši tzv. **putatívnu (domnelú) obranu** — omylné presvedčenie o hroziacom útoku, ktoré ak je zavinené nedbanlivo, zakladá zodpovednosť len za nedbanlivostný čin (nie úmyselný).
...
Odsek 1 je odkazujúcou normou na osobitné predpisy upravujúce oprávnenia použiť zbraň (napr. príslušníkmi ozbrojených zborov). Odsek 2 obsahuje samostatné, prakticky významné pravidlo tzv. **domovej obrany** — rozširuje beztrestnosť použitia zbrane proti neoprávnene vniknutej osobe vo vlastnom obydlí aj na prípady, ktoré by nespĺňali prísnejšie podmienky nutnej obrany (§ 25), s výnimkou úmyselného spôsobenia smrti, ktoré týmto ustanovením kryté nie je.
...
Kryje spoločensky prospešnú výrobnú a výskumnú činnosť, ktorá je nevyhnutne spojená s určitým rizikom (napr. klinické skúšanie, experimentálny výskum) — podmienkou je súlad s aktuálnym stavom poznania a primeranosť rizika k očakávanému prínosu (odsek 2 vylučuje neprimerané riziko alebo činnosť odporujúcu právu, verejnému záujmu, ľudskosti či dobrým mravom).
...
Odsek 1 kryje konanie, ktoré je výkonom zákonného práva či povinnosti (napr. zákrok príslušníka ozbrojeného zboru, výkon exekučného titulu) — podmienkou je zákonnosť samotného spôsobu výkonu. Odsek 2 výslovne **vylučuje obranu "na príkaz"** pri najzávažnejších zločinoch proti ľudskosti (genocída, nedobrovoľné zmiznutie, neľudskosť) — splnenie rozkazu tu nikdy nevylučuje protiprávnosť. Odsek 3 stanovuje pre vojnové bezprávie (§ 433) jemnejšiu, ale stále prísnu výnimku — obrana príkazom je vylúčená, ibaže by páchateľ súčasne mal zákonnú povinnosť príkaz splniť, o jeho nezákonnosti nevedel a ani z jeho obsahu nezákonnosť nevyplývala.
...
Súhlas poškodeného v zásade vylučuje protiprávnosť, s dôležitou výnimkou pri zásahoch do života a zdravia (odsek 1, druhá veta) — tam súhlas spravidla nepostačuje, výnimkou je len riadne poskytnutá zdravotná starostlivosť (lex artis). Odsek 2 stanovuje kvalitatívne požiadavky na platný súhlas (vážnosť, dobrovoľnosť, zrozumiteľnosť) a vylučuje jeho účinky, ak bol vynútený iným trestným činom (napr. vydieraním). Odsek 3 je zvyškovou klauzulou pre skutkové podstaty, kde zákon výslovne trestnosť súhlasom nevylučuje.
...
Kryje špecifickú situáciu agenta pôsobiaceho v zločineckej alebo teroristickej skupine, ktorý je pod nátlakom skupiny alebo v obave o život/zdravie donútený spáchať čin inak trestný (odsek 1) — ide o osobitnú formu krajnej núdze prispôsobenú realite operatívno-pátracej činnosti. Odsek 2 taxatívne vylučuje z tejto beztrestnosti najzávažnejšie trestné činy (vraždy, sexuálne násilie, terorizmus, vojnové zločiny) a spôsobenie ťažkej ujmy na zdraví či smrti — krytie agenta má svoje absolútne hranice. Odsek 3 samostatne rieši predstieranie prevodu veci a súvisiace úkony (§ 332 – § 334, § 336 ods. 2) použité ako legitímna vyšetrovacia metóda proti korupčnej a obdobnej trestnej činnosti, ak sa uskutočnia postupom podľa Trestného poriadku.
